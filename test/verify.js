...
const suites = [
  ...
  { name: '3b. Exact Source Links & Structured Data Safety', cmd: 'node --experimental-strip-types --test test/source-integrity.test.mjs test/discovery-workbench-chips.test.mjs' },
  { name: '3c. Evidence-Only Enrichment, Exports, Underwriting, Legal Rules & CORS', cmd: 'node --test test/cors-policy.test.js test/api-rate-policy.test.js test/api-rate-http.test.js test/enrich-evidence.test.js test/export-truth.test.js test/underwriting-truth.test.mjs test/legal-rules-truth.test.js' },
  ...
  { name: '3i. Discovery backend', cmd: 'npm run test:discovery' },
  { name: '3j. Discovery operations', cmd: 'npm run test:discovery:operations' },
  { name: '3k. Property documents', cmd: 'npm run test:property-documents' },
  { name: '3l. Walkthrough providers', cmd: 'npm run test:walkthrough-providers' },
  ...
  { name: '9a. Production boot + user workflow e2e', cmd: 'node scripts/run-production-e2e.js' },
  { name: '10. Canonical Next Runtime Contract', cmd: 'node --test test/canonical-runtime.test.js test/production-boot.test.js' },
