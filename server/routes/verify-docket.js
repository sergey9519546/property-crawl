...
async function handleVerifyDocket(req, res) {
  ...
  // If not found in DB or custom address provided
  ...
  // Deterministic docket case number derivation
  ...
  // Deterministic risk status arbitration
  // Check for known bankruptcy or adjournment triggers
  let status = 'active';
  let statusReason = 'Auction confirmed active. Sheriff execution writ issued and served.';
  let bankruptcyStay = false;
