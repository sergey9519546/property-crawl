...
const SUITES = [
  ...
  { id: 'listing-intelligence', cmd: [process.execPath, ['--test', 'test/listing-intelligence.test.js', 'test/scraper-upgrade.test.js', 'test/market-enrollment.test.js']], envRequired: false },
