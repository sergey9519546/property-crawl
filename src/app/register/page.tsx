      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="rounded-3xl border border-[#E2E8F0] bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-sm text-[#64748B]">
            Start finding distressed property deals before everyone else.
          </p>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label htmlFor="register-name" className="mb-1.5 block text-xs font-bold uppercase tracking-wide text-[#64748B]">
                Name
              </label>
              <input
                id="register-name"
            ...
            <div>
              <label htmlFor="register-email" className="mb-1.5 block text-xs font-bold uppercase tracking-wide text-[#64748B]">
                Email
              </label>
              <input
                id="register-email"
            ...
            <div>
              <label htmlFor="register-password" className="mb-1.5 block text-xs font-bold uppercase tracking-wide text-[#64748B]">
                Password
              </label>
              <input
