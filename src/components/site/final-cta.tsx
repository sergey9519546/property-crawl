      ...
      <div className="mx-auto flex max-w-[1080px] flex-col items-start justify-between gap-6 px-5 sm:flex-row sm:items-center lg:px-8">
        <GsapReveal>
          <h2 className="text-[26px] font-medium leading-[1.17] tracking-[-0.015em] text-[#111827] sm:text-[32px] lg:text-[36px]">
            Open the listing workspace. Evidence first.
          </h2>
        </GsapReveal>
        <div className="flex shrink-0 items-center gap-3">
          ...
          <a
            href="/sign-in"
            className="inline-flex h-10 items-center justify-center rounded-[12px] border border-[#D1D5DB] px-4 text-[14px] font-semibold text-[#374151] transition-colors hover:bg-white"
          >
            Operator access
          </a>
        </div>
